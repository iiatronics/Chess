...
* Testing: xUnit
* AI Assistance: Google Gemini was used for code analysis, debugging, and resolving logic errors during, generating pictures for buttons the development process.
